...
function StreeHub:Window(GuiConfig)
    ...
    Close.Activated:Connect(function()
        ...
        Gradient.Color = ColorSequence.new({
            ...
            ColorSequenceKeypoint.new(0.5, Color3.fromRGB(20, 200, 20)),
    ...
    DropdownSelectReal.BackgroundColor3 = Color3.fromRGB(20, 98, 0)
        ...
        function Sections:AddSection(Title, AlwaysOpen)
            ...
            function Items:AddSlider(SliderConfig)
                ...
                local function Round(Number, Factor)
                    local Result = math.floor(Number / Factor + (sign(Number) * 0.5)) * Factor
                    if Result < 0 then
