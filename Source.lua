...
local function MakeDraggableToggle(topbarobject, object, callback)
	local Dragging = false
	local DragInput = nil
	local DragStart = nil
	local StartPosition = nil
	...
	local function UpdatePos(input)
		...
		local Delta = input.Position - DragStart
		local moveDistance = (Delta.X ^ 2 + Delta.Y ^ 2) ^ 0.5
	...
	topbarobject.InputEnded:Connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
			if Dragging and not HasMoved and callback then
				callback()
			end
			Dragging = false
			DragStart = nil
...
function CircleClick(Button, X, Y)
	spawn(function()
		...
		Circle.Image = "rbxassetid://140084565218977"
...
function FlurioreLib:MakeGui(GuiConfig)
	...
	TextLabel1.BorderColor3 = Color3.fromRGB(0, 0, 0)
	TextLabel1.BorderSizePixel = 0
	TextLabel1.Size = UDim2.new(0, 0, 0, 0)
	TextLabel1.Position = UDim2.new(0, TextLabel.TextBounds.X + 15, 0, 0)
	TextLabel1.Parent = Top
	...
	-- toggle ui disini ya bg
	local ToggleButton = Instance.new("ImageButton")
	local ToggleCorner = Instance.new("UICorner")
	local ToggleShadow = Instance.new("ImageLabel")
	
	ToggleButton.Name = "ToggleButton"
	ToggleButton.Parent = HirimiGui
	ToggleButton.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
	ToggleButton.Position = UDim2.new(0.1, 0, 0.1, 0)
	ToggleButton.Size = UDim2.new(0, 50, 0, 50)
	ToggleButton.Image = "rbxassetid://123032091977400" 
	...
	MakeDraggableToggle(ToggleButton, ToggleButton, ToggleInterface)
