...
if not isfolder("StreeLib") then
    makefolder("StreeLib")
end
if not isfolder("StreeLib/Config") then
    makefolder("StreeLib/Config")
end
...
local ConfigFile = "StreeLib/Config/" .. gameName .. ".json"
...
function CircleClick(Button, X, Y)
    spawn(function()
        ...
        Circle.ImageColor3 = Color3.fromRGB(0, 255, 0) -- Hijau neon
...
local Stree = {}
function Stree:MakeNotify(NotifyConfig)
    local NotifyConfig = NotifyConfig or {}
    NotifyConfig.Title = NotifyConfig.Title or "Stree Library"
    NotifyConfig.Description = NotifyConfig.Description or "Notification"
    NotifyConfig.Content = NotifyConfig.Content or "Content"
    NotifyConfig.Color = NotifyConfig.Color or Color3.fromRGB(0, 255, 0) -- Hijau neon
    ...
    spawn(function()
        ...
        ImageLabel.ImageColor3 = Color3.fromRGB(0, 255, 0) -- Hijau neon
...
function Notify(msg, delay, color, title, desc)
    return Stree:MakeNotify({
        Title = title or "Stree Library",
        Description = desc or "Notification",
        Content = msg or "Content",
        Color = color or Color3.fromRGB(0, 255, 0), -- Hijau neon
        Delay = delay or 4
    })
end

function Stree:Window(GuiConfig)
    GuiConfig              = GuiConfig or {}
    GuiConfig.Title        = GuiConfig.Title or "Stree Library"
    GuiConfig.Footer       = GuiConfig.Footer or "v1.0"
    GuiConfig.Color        = GuiConfig.Color or Color3.fromRGB(0, 255, 0) -- Hijau neon
    ...
    local StreeUI = Instance.new("ScreenGui");
    local DropShadowHolder = Instance.new("Frame");
    local DropShadow = Instance.new("ImageLabel");
    ...
    StreeUI.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    StreeUI.Name = "StreeUI"
    StreeUI.ResetOnSpawn = false
    StreeUI.Parent = game:GetService("CoreGui")
    ...
    DropShadowHolder.ZIndex = 0
    DropShadowHolder.Name = "DropShadowHolder"
    DropShadowHolder.Parent = StreeUI

    DropShadowHolder.Position = UDim2.new(0, (StreeUI.AbsoluteSize.X // 2 - DropShadowHolder.Size.X.Offset // 2), 0,
        (StreeUI.AbsoluteSize.Y // 2 - DropShadowHolder.Size.Y.Offset // 2))
    ...
    ImageLabel1.ImageColor3 = Color3.fromRGB(0, 255, 0) -- Hijau neon
    ...
    ImageLabel2.ImageColor3 = Color3.fromRGB(0, 255, 0) -- Hijau neon
    ...
    NameTab.Text = ""
    NameTab.TextColor3 = Color3.fromRGB(0, 255, 0) -- Hijau neon
    NameTab.TextSize = 24
    ...
    function GuiFunc:DestroyGui()
        if CoreGui:FindFirstChild("StreeUI") then
            StreeUI:Destroy()
        end
    end
    ...
    Close.Activated:Connect(function()
        ...
        Gradient.Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0.0, Color3.fromRGB(0, 255, 0)), -- Hijau neon
            ColorSequenceKeypoint.new(0.25, Color3.fromRGB(255, 255, 255)),
            ColorSequenceKeypoint.new(0.5, Color3.fromRGB(0, 255, 128)), -- Hijau cerah
            ColorSequenceKeypoint.new(0.75, Color3.fromRGB(255, 255, 255)),
            ColorSequenceKeypoint.new(1.0, Color3.fromRGB(0, 255, 0)) -- Hijau neon
        })
        ...
        Title.Text = "Stree Library"
        Title.TextSize = 22
        Title.TextColor3 = Color3.fromRGB(0, 255, 0) -- Hijau neon
        Title.ZIndex = 52
        Title.Parent = Dialog
        ...
        Yes.BackgroundColor3 = Color3.fromRGB(0, 255, 0) -- Hijau neon
        Yes.BackgroundTransparency = 0.8
        Yes.Text = "Yes"
        ...
        Yes.MouseButton1Click:Connect(function()
            if StreeUI then StreeUI:Destroy() end
    ...
    function GuiFunc:ToggleUI()
        ...
        MainButton.Image = "rbxassetid://" .. (GuiConfig.Image or "9542022979")
        MainButton.ImageColor3 = Color3.fromRGB(0, 255, 0) -- Hijau neon
    ...
    UIStroke14.Color = Color3.fromRGB(0, 255, 0) -- Hijau neon
    UIStroke14.Thickness = 2.5
    UIStroke14.Transparency = 0.8
    UIStroke14.Parent = DropdownSelect

    DropdownSelectReal.AnchorPoint = Vector2.new(0.5, 0.5)
    DropdownSelectReal.BackgroundColor3 = Color3.fromRGB(0, 50, 0) -- Hijau gelap
    ...
    function Tabs:AddTab(TabConfig)
        ...
        function Sections:AddSection(Title, AlwaysOpen)
            ...
            FeatureImg.ImageColor3 = Color3.fromRGB(0, 255, 0) -- Hijau neon
            ...
            function Items:AddParagraph(ParagraphConfig)
                ...
                ParagraphTitle.TextColor3 = Color3.fromRGB(0, 255, 0) -- Hijau neon
                ...
                if ParagraphConfig.ButtonText then
                    ...
                    ParagraphButton.BackgroundColor3 = Color3.fromRGB(0, 255, 0) -- Hijau neon
                    ParagraphButton.BackgroundTransparency = 0.8
            ...
            function Items:AddPanel(PanelConfig)
                ...
                if PanelConfig.Placeholder then
                    ...
                    InputBox.TextColor3 = Color3.fromRGB(0, 255, 0) -- Hijau neon
                ...
                ButtonMain.BackgroundColor3 = Color3.fromRGB(0, 255, 0) -- Hijau neon
            ...
            function Items:AddButton(ButtonConfig)
                ...
                MainButton.BackgroundColor3 = Color3.fromRGB(0, 255, 0) -- Hijau neon
                MainButton.BackgroundTransparency = 0.8
            ...
            function Items:AddInput(InputConfig)
                ...
                InputTextBox.TextColor3 = Color3.fromRGB(0, 255, 0) -- Hijau neon
            ...
            function Items:AddDropdown(DropdownConfig)
                ...
                OptionSelecting.TextColor3 = Color3.fromRGB(0, 255, 0) -- Hijau neon
                ...
                OptionImg.ImageColor3 = Color3.fromRGB(0, 255, 0) -- Hijau neon
                ...
                SearchBox.TextColor3 = Color3.fromRGB(0, 255, 0) -- Hijau neon
            ...
            function Items:AddSubSection(title)
                ...
                Label.Text = "──> " .. title .. " <──"
                Label.TextColor3 = Color3.fromRGB(0, 255, 0) -- Hijau neon
                Label.TextSize = 12
